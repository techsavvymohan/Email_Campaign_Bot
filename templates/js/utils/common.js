...
function setDatetimeToLocal(datetimeElement, additonal_time=0){
    ...
    // Calculate the datetime with additional time added
    ...
    datetimeElement?.setAttribute('min', localString);
...
function toLocalTime(datetime){
    ...
    return datetime.toLocaleString('en-IN', options) + ' IST';
...
function renderTemplate(template, context){
    ...
    copyContext['from_email'] = copyContext['from_email'] || "user@example.com";
    copyContext['from_name'] = copyContext['from_name'] || "Your Name";
    copyContext['from_signature'] = copyContext['from_signature'] || "Best regards,\nYour Name";
