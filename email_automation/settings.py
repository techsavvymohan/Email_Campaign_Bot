...
MIDDLEWARE = [
    ...
    'user.middleware.AutoLoginMiddleware',
...
EMAIL_FROM_SIGNATURE = 'Best regards,\nCampaign Team'
EMAIL_FROM = 'outreach@example.com'
EMAIL_FROM_NAME = 'Email Campaign Studio'
...
if DEBUG:
    ...
    CACHES = {
        'default': {
            ...
            'LOCATION': f"{env('REDIS_PROD_HOST')}/0",
            'OPTIONS': {
